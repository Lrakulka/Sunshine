...
import com.task.krabiysok.sunshine.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                ...
                mContext.getString(R.string.pref_temperature_system_default));

        if (unitType.equals(mContext.getString(R.string.pref_temperature_system_imperial))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.pref_temperature_system_default))) {
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, array);
            }
